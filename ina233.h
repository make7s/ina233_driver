...
/*=========================================================================
    ...
    #define b_p                (0)
/*=========================================================================*/
typedef void (*i2c_write_byte) (uint8_t reg, uint8_t value);
typedef void (*i2c_write_word) (uint8_t reg, uint16_t value);

typedef void (*i2c_read_block)(uint8_t reg, uint8_t value[6]);
typedef void (*i2c_read_word)(uint8_t reg, uint16_t *value);
typedef void (*i2c_read_byte)(uint8_t reg, uint8_t *value);
